...
public class Graph {
	...
	public static class Edge {
		...
		public final GridPoint startPoint, endPoint;

		public Edge(String v1, String v2, int dist, GridPoint startPoint, GridPoint endPoint) {
			this.v1 = v1;
			this.v2 = v2;
			this.dist = dist;
	...
	public static class Vertex implements Comparable<Vertex> {
		...
		public Vertex(String name, GridPoint pt) {
			this.name = name;
			this.pt = pt;
		}
	...
	public Graph(Edge[] edges) {
		...
		for (Edge e : edges) {
			if (!graph.containsKey(e.v1))
				graph.put(e.v1, new Vertex(e.v1, e.startPoint));
			if (!graph.containsKey(e.v2))
				graph.put(e.v2, new Vertex(e.v2, e.endPoint));
		}
